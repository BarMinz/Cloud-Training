...
import { Cloud, Eye, EyeOff, Loader2, ArrowLeft, CheckCircle } from 'lucide-react'
    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="card p-8 max-w-sm w-full text-center space-y-4">
          <p className="text-slate-300 text-sm">Invalid reset link. Please request a new one.</p>
          <Link to="/forgot-password" className="btn-primary inline-block">Request Reset</Link>
        </div>
      </div>
    )
  }
